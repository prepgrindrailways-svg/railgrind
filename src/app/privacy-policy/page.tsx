...
export const metadata: Metadata = {
  title: 'Privacy Policy | RailGrind',
  description: 'Privacy policy for RailGrind users.',
};
  ...
  return (
    <div className="container section">
      ...
      <p style={{ fontSize: '1.125rem', color: 'var(--text-muted)', marginBottom: '2rem' }}>
        Privacy policy for RailGrind users.
      </p>
      
      <div className="card" style={{ padding: '3rem', textAlign: 'center', backgroundColor: 'var(--surface)' }}>
        <h2>Content Coming Soon</h2>
        <p style={{ color: 'var(--text-muted)', marginTop: '1rem' }}>
          We are working hard to bring you the best privacy policy for your railway exam preparation. Stay tuned!
        </p>
      </div>
    </div>
  );
